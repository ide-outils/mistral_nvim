...
use quote::ToTokens;
use syn::{
    Data, DeriveInput, Expr, ExprPath, GenericArgument, GenericParam, Generics, Macro, Path, PathArguments, QSelf,
    ReturnType, Token, Type, TypeParamBound, TypePath, WherePredicate, parse_quote,
};
...
impl ReplaceReceiver<'_> {
    ...
    fn self_to_expr_path(&self, path: &mut Path) {
        ...
        if variant.segments.len() > 1 {
            ...
            path.segments
                .extend(variant.segments.into_pairs().skip(1));
        }
    }
}
